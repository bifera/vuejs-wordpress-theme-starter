...
export const STORE_FETCHED_CAKES = 'STORE_FETCHED_CAKES'
export const CAKES_LOADED = 'CAKES_LOADED'

export const STORE_FETCHED_MENU_ITEMS = 'STORE_FETCHED_MENU_ITEMS'
